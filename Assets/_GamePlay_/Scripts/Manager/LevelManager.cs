...
public class LevelManager : MonoBehaviour
{
    ...
    {
        if (levelData == null) return default;
    ...
    private bool TryPinTutorial(FoodData entry, out FoodSlot emptySlot, out FoodSlot donorSlot, out FoodSlot t1, out FoodSlot t2)
    {
