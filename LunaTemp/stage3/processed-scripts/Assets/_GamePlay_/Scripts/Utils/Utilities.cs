...
public static class Utilities
{
    ...
    public static Vector2 CalculateLinePoint([Bridge.Ref] Vector2 throwPoint, [Bridge.Ref] Vector2 force, float wind, float t)
    {
    ...
    public static float CaculateRatioVelocity([Bridge.Ref] Vector2 throwPoint, [Bridge.Ref] Vector2 force, [Bridge.Ref] Vector2 targetPoint, float wind)
    {
    ...
    public static float TimeToTarget([Bridge.Ref] Vector2 throwPoint, [Bridge.Ref] Vector2 force, [Bridge.Ref] Vector2 targetPoint, float wind)
    {
        float dx = targetPoint.x - throwPoint.x;
        float dy = targetPoint.y - throwPoint.y;
    ...
    public static T Last<T>(this List<T> ts) => ts[ts.Count - 1];
    ...
    //index = 0 -> max - 1
    public static Vector3 GetPositionInRow(int index, int max, [Bridge.Ref] Vector3 midPoint, [Bridge.Ref] Vector3 space)
    {
    ...
    public static void Shuffle<T>(Queue<T> queue)
    {
