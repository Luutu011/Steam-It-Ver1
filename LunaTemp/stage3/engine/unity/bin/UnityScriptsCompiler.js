...
if ( TRACE ) { TRACE( "DragManager#HandleDragging", this ); }
                ...
                if (this.limitDragTime <= 0) {
                    Ply_Singleton$1(GameManager).Ins.GoToStore();
                    Ply_Singleton$1(GameManager).Ins.isGameOver = true;
                    return;
                }

                if (Ply_Singleton$1(GameManager).Ins.isGameOver || Ply_Singleton$1(GameManager).Ins.HasReachedLimit()) {
                    return;
                }
                if (!this.canDrag) {
                    return;
                ...
                if (UnityEngine.Input.GetMouseButtonDown(0)) {
                    UnityEngine.Debug.Log$1("Mouse down");
                    if (!Ply_Singleton$1(GameManager).Ins.isGameStart && !this.isPlayMusic) {
                        UnityEngine.Debug.Log$1("Play music");
                        this.bgMusic.Play();
                    ...
                    if (UnityEngine.Physics.Raycast$1(ray, hit, window.Infinity, UnityEngine.LayerMask.op_Implicit(this.draggableLayer.$clone()))) {
                        ...
                        if (UnityEngine.MonoBehaviour.op_Inequality(slot, null) && slot.food.foodType !== FoodEnum.None) {
                            ...
                            // End tutorial
                            UnityEngine.MonoBehaviour.op_Inequality(($t = Ply_Singleton$1(TutorialManager).Ins), null) ? $t.EndTutorial() : null;
                            UnityEngine.MonoBehaviour.op_Inequality(($t1 = Ply_Singleton$1(GuideManager).Ins), null) ? $t1.Hide() : null;
                            ...
                            Ply_Singleton$1(GameManager).Ins.isGameStart = true;
...
if ( TRACE ) { TRACE( "GameManager#inherits", this ); }
 return [Ply_Singleton$1(GameManager)]; },
        fields: {
...
if ( TRACE ) { TRACE( "GameManager#WinLevel", this ); }
                ...
                Ply_Singleton$1(UIManager).Ins.LevelWon();
                this.GoToStore();
            },
                            ...
                            switch ($step) {
                                ...
                                case 4: {
                                    // Animate dish flying out
                                        ...
                                        Ply_Singleton$1(GameManager).Ins.OnGrillCleared();
...
if ( TRACE ) { TRACE( "Grill#TryAddFood", this ); }
                ...
                targetSlot.AddFood(Ply_Singleton$1(LevelManager).Ins.GetFoodData(foodType));
                return true;
            },
...
if ( TRACE ) { TRACE( "Grill#GetFirstEmptySlot", this ); }
    ...
    Bridge.define("GuideManager", {
        inherits: function () {
if ( TRACE ) { TRACE( "GuideManager#inherits", this ); }
 return [Ply_Singleton$1(GuideManager)]; },
        fields: {
            idleThreshold: 0,
            wobbleAngle: 0,
            wobbleSpeed: 0,
                ...
                if (this.isTutorialActive) {
                    ...
                    if (this.tutorialTriplet.Count > 0) {
                        ...
                        if (UnityEngine.MonoBehaviour.op_Inequality(this.tutorialDonor, null) && UnityEngine.MonoBehaviour.op_Inequality(this.tutorialTarget, null)) {
                            UnityEngine.MonoBehaviour.op_Inequality(($t = Ply_Singleton$1(TutorialManager).Ins), null) ? $t.StartHandGuide(this.tutorialDonor.TF.position, this.tutorialTarget.TF.position) : null;
                        }
                    }
                } else {
...
if ( TRACE ) { TRACE( "GuideManager#ResetIdle", this ); }
                ...
                if (this.isShowing) {
                    ...
                    UnityEngine.MonoBehaviour.op_Inequality(($t1 = Ply_Singleton$1(TutorialManager).Ins), null) ? $t1.HideHand() : null;
...
if ( TRACE ) { TRACE( "LevelManager#inherits", this ); }
 return [Ply_Singleton$1(LevelManager)]; },
        statics: {
            methods: {
...
if ( TRACE ) { TRACE( "LevelManager#GenerateLevel", this ); }
                ...
                if (tutorialPinned) {
                    ...
                    UnityEngine.MonoBehaviour.op_Inequality(($t5 = Ply_Singleton$1(GuideManager).Ins), null) ? $t5.SetTutorialMove(donorSlot.v, emptySlot.v, target1.v, target2.v) : null;
                    UnityEngine.MonoBehaviour.op_Inequality(($t6 = Ply_Singleton$1(TutorialManager).Ins), null) ? $t6.StartHandGuide(donorSlot.v.TF.position, emptySlot.v.TF.position) : null;
                }
            },
...
if ( TRACE ) { TRACE( "TutorialManager#inherits", this ); }
 return [Ply_Singleton$1(TutorialManager)]; },
        fields: {
            handGuide: null,
            isTutorial: false,
            handTween: null
...
if ( TRACE ) { TRACE( "UIManager#inherits", this ); }
 return [Ply_Singleton$1(UIManager)]; },
        fields: {
            portraitPanel: null,
            landscapePanel: null,
            resultPanel: null,
