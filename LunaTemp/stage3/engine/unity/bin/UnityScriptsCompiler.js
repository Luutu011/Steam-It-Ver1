...
if ( TRACE ) { TRACE( "FoodSlotGraphicController#OnClearFood", this ); }
                ...
                if (indexInGrill === 0) {
                    offset = new pc.Vec3( 0.0, this.foodOffsetHeight * 0.5, 0.0 );
                } else if (indexInGrill === 1) {
                    offset = new pc.Vec3( -this.foodOffsetWidth, -this.foodOffsetHeight * 0.5, 0.0 );
                } else if (indexInGrill === 2) {
                    offset = new pc.Vec3( this.foodOffsetWidth, -this.foodOffsetHeight * 0.5, 0.0 );
                }

                var targetWorldPos = targetTransform.position.$clone().add( offset );
...
if ( TRACE ) { TRACE( "LevelManager#GenerateLevel", this ); }
                ...
                if (tutorialPinned) {
                    ...
                    UnityEngine.MonoBehaviour.op_Inequality(($t3 = GuideManager.Instance), null) ? $t3.SetTutorialMove(donorSlot.v, emptySlot.v, target1.v, target2.v) : null;
                    UnityEngine.MonoBehaviour.op_Inequality(($t4 = TutorialManager.Instance), null) ? $t4.StartHandGuide(donorSlot.v.TF.position, emptySlot.v.TF.position) : null;
                }
            },
                ...
                if (UnityEngine.Input.GetMouseButtonDown(0)) {
                    ...
                    if (UnityEngine.Physics.Raycast$1(ray, hit, window.Infinity, UnityEngine.LayerMask.op_Implicit(this.draggableLayer.$clone()))) {
                        ...
                        if (UnityEngine.MonoBehaviour.op_Inequality(slot, null) && slot.food.foodType !== FoodEnum.None) {
                            ...
                            // Play Tap SFX
                            UnityEngine.MonoBehaviour.op_Inequality(($t2 = Ply_Singleton$1(SoundManager).Ins), null) ? $t2.PlayFx(FxType.Tap) : null;
                    ...
                    if (UnityEngine.Physics.Raycast$1(ray1, hit1, window.Infinity, UnityEngine.LayerMask.op_Implicit(this.grillLayer.$clone()))) {
                        ...
                        if (UnityEngine.MonoBehaviour.op_Inequality(targetSlot, null) && UnityEngine.MonoBehaviour.op_Inequality(targetSlot, this.currentSourceSlot) && targetSlot.food.foodType === FoodEnum.None) {
                            ...
                            if (UnityEngine.MonoBehaviour.op_Inequality(actualTargetGrill, null) && !actualTargetGrill.IsClosed) {
                                ...
                                // Play Placed SFX
                                UnityEngine.MonoBehaviour.op_Inequality(($t3 = Ply_Singleton$1(SoundManager).Ins), null) ? $t3.PlayFx(FxType.Placed) : null;
                            }
                        }
                    }
                            ...
                            switch ($step) {
                                case 0: {
                                    this.IsClosed = true; // prevent re-triggering
                                        ...
                                        // Play clearing SFX
                                        UnityEngine.MonoBehaviour.op_Inequality(($t = Ply_Singleton$1(SoundManager).Ins), null) ? $t.PlayFx(FxType.FlyToDish) : null;
                                        ...
                                        $t1 = Bridge.getEnumerator(this.foodSlots);
                                        try {
                                            while ($t1.moveNext()) {
                                                slot1 = $t1.Current;
                                                slot1.Clear();
...
if ( TRACE ) { TRACE( "SoundManager#Mute", this ); }
    ...
    /*SoundManager start.*/
    $m("SoundManager", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"Mute","t":8,"sn":"Mute","rt":$n[0].Void},{"a":2,"n":"PlayFx","t":8,"pi":[{"n":"fxType","pt":FxType,"ps":0}],"sn":"PlayFx","rt":$n[0].Void,"p":[FxType]},{"a":2,"n":"audioClips","t":4,"rt":System.Array.type(UnityEngine.AudioClip),"sn":"audioClips"},{"a":1,"n":"fx","t":4,"rt":System.Array.type(UnityEngine.AudioSource),"sn":"fx"},{"a":1,"n":"isMute","t":4,"rt":$n[0].Boolean,"sn":"isMute","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"sound","t":4,"rt":$n[1].AudioSource,"sn":"sound"}]}; }, $n);
    /*SoundManager end.*/
