...
if ( TRACE ) { TRACE( "FoodSlotGraphicController#OnClearFood", this ); }
                ...
                var xOffset = (((indexInGrill - 1) | 0)) * this.foodOffsetWidth;
                var targetWorldPos = targetTransform.position.$clone().add( new pc.Vec3( xOffset, 0.0, 0.0 ) );
...
if ( TRACE ) { TRACE( "FoodSlotGraphicController#AnimateDishOut", this ); }
                ...
                // Move the dish away
                var targetPos = this.dish.transform.position.$clone().add( new pc.Vec3( 5.0, 2.0, 0.0 ) );
                DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOMove(this.dish.transform, targetPos.$clone(), 0.6), DG.Tweening.Ease.InBack);
...
if ( TRACE ) { TRACE( "GrillGraphicController#CloseCoverAnimation", this ); }
                ...
                DG.Tweening.DOTweenModuleSprite.DOColor(this.coverSR, new pc.Color( 1, 1, 1, 0.7 ), 0.2);
...
if ( TRACE ) { TRACE( "DragManager#HandleDragging", this ); }
                ...
                if (UnityEngine.Input.GetMouseButtonUp(0) && UnityEngine.MonoBehaviour.op_Inequality(this.currentSourceSlot, null)) {
                    ...
                    if (UnityEngine.Physics.Raycast$1(ray1, hit1, window.Infinity, UnityEngine.LayerMask.op_Implicit(this.draggableLayer.$clone()))) {
                        ...
                        if (UnityEngine.MonoBehaviour.op_Inequality(targetSlot, null) && UnityEngine.MonoBehaviour.op_Inequality(targetSlot, this.currentSourceSlot) && targetSlot.food.foodType === FoodEnum.None) {
                            var targetGrill = targetSlot.GetComponentInParent(Grill);
                            if (UnityEngine.MonoBehaviour.op_Inequality(targetGrill, null) && !targetGrill.IsClosed) {
                                // Transfer Data
